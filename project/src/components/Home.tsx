...
const dispatches: Dispatch[] = [
  {
    ...
    read: '12 MIN',
    title: 'An End-to-End MLOps Demo Repo: Terraform AKS, GitHub Actions, MLflow, KServe, drift monitoring in one make up',
  ...
  },
  {
    ...
    read: '14 MIN',
    title: 'Detecting model drift in production with Evidently AI, Prometheus, Grafana, and AlertManager',
  ...
  },
  {
    ...
    topic: 'CI/CD · MLOps',
    read: '16 MIN',
    title: 'A GitHub Actions pipeline for ML model CI/CD with DVC, MLflow, Trivy, Bandit, and ArgoCD',
