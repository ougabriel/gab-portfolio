      ...
      <section className="hairline-b">
        <div className="page" style={{ paddingTop: '3.5rem', paddingBottom: '3.5rem' }}>
          ...
          <p className="prose-mono" style={{ marginTop: '2rem' }}>
            Gabriel Okom — MLOps and platform engineer at <em>KPMG (Microsoft Business
            Solutions)</em>. I build secure CI/CD pipelines, ship containerised ML
            inference on Kubernetes, and run AI-driven audit workloads on Azure.
            This is the log: long-form articles, recorded walkthroughs, and the
            field notes behind them — written from real production work, not slideware.
          </p>
